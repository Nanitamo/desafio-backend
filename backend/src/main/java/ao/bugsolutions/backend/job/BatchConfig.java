package ao.bugsolutions.backend.job;
...
import ao.bugsolutions.backend.entity.TransacaoCNAB;
...
public class BatchConfig {
    ...
    /*
     * Alteracao feita no Metodo processor()
     * usar o valor sem chamada do Metodo withValor()
     */
    @Bean
