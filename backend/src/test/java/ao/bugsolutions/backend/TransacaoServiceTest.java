package ao.bugsolutions.backend;
...
public class TransacaoServiceTest {
    ...
    public void testListTotaisTransacoesByNomeDaLoja(){
        ...
        var transacao1 = new Transacao(
            ...
            BigDecimal.valueOf(100), 1212121212323L, "1234-5678-9012-3456", new Time(System.currentTimeMillis()), 
            "Dono da Loja A", lojaA);

        var transacao2 = new Transacao(
        2L, 1, new Date(System.currentTimeMillis()), 
        BigDecimal.valueOf(50), 14343545454L, "1111-3333-5555-666", new Time(System.currentTimeMillis()),             
        "Dono da Loja B", lojaB);

        var transacao3 = new Transacao(
        3L, 1, new Date(System.currentTimeMillis()), 
        BigDecimal.valueOf(75.00), 89899933434L, "6666-8888-2222-0000", new Time(System.currentTimeMillis()),             
        "Dono da Loja A", lojaA);

        List<Transacao> mockTransacoes = new ArrayList<>();
         mockTransacoes.add(transacao1);
         mockTransacoes.add(transacao2);
         mockTransacoes.add(transacao3);
